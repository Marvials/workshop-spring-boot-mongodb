...
import com.marvi.workshopmongo.dto.AuthorDTO;
import com.marvi.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("04/01/2023"), "Partiu viagem 2.0", "Vou viajar para Rio Grande do Sul, Abraços", new AuthorDTO(maria));
